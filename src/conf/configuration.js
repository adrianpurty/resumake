var config = {
  adminEmail:"admin@resumake.pro",  // The website will consider this email  as an admin 
  brand: {
  ...
  meta:{
    ...
    description:" Resumake.Pro is a Free, Fast & Easy PDF Download. 8+ Professional Resume Templates to Get You Hired Today! Stop Struggling With Word! Choose a Resume Template and Create Your Resume in 5 Minutes.", // Description here ( This one will show up in search engines)
